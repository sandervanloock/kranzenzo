...
import {Principal, User, UserService} from '../../../../../../main/webapp/app/shared';
    ...
    describe( 'User Management Component', () => {
        ...
        beforeEach( async( () => {
            TestBed.configureTestingModule( {
                                                imports: [KransenzoTestModule], declarations: [UserMgmtComponent], providers: [UserService]
                                            } )
        ...
        describe( 'OnInit', () => {
            it( 'Should call load all on init', inject( [], fakeAsync( () => {
                // GIVEN
                const headers = new Headers();
                headers.append( 'link', 'link;link' );
                spyOn( service, 'query' ).and.returnValue( Observable.of( {
                                                                              json: [new User( 123 )], headers
                                                                          } ) );
        ...
        describe( 'setActive', () => {
            it( 'Should update user and call load all', inject( [], fakeAsync( () => {
                // GIVEN
                const headers = new Headers();
                headers.append( 'link', 'link;link' );
