    ...
    describe( 'User Management Detail Component', () => {
        ...
        beforeEach( async( () => {
            TestBed.configureTestingModule( {
                                                imports: [KransenzoTestModule], declarations: [UserMgmtDetailComponent], providers: [{
                    provide: ActivatedRoute, useValue: new MockActivatedRoute( {login: 'user'} )
                }, UserService]
                                            } )
        ...
        describe( 'OnInit', () => {
            it( 'Should call load all on init', () => {
                ...
                spyOn( service, 'find' ).and.returnValue(
                    Observable.of( new User( 1, 'user', 'first', 'last', 'first@last.com', true, 'en', ['ROLE_USER'], 'admin', null, null, null ) ) );
