    ...
    describe( 'User Management Dialog Component', () => {
        ...
        beforeEach( async( () => {
            TestBed.configureTestingModule( {
                                                imports: [KransenzoTestModule], declarations: [UserMgmtDialogComponent], providers: [UserService]
                                            } )
        ...
        describe( 'OnInit', () => {
            it( 'Should load authorities and language on init', inject( [], fakeAsync( () => {
                // GIVEN
        ...
        describe( 'save', () => {
            it( 'Should call update service on save for existing user', inject( [], fakeAsync( () => {
                // GIVEN
            ...
            it( 'Should call create service on save for new user', inject( [], fakeAsync( () => {
                // GIVEN
