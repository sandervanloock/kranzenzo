    ...
    describe('Workshop Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/workshops';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Workshop', () => {
                service.create(new Workshop(null)).subscribe(received => {
            ...
            it('should update a Workshop', () => {
                service.update(new Workshop(123)).subscribe(received => {
