...
import {OrderDeleteDialogComponent} from '../../../../../../main/webapp/app/entities/order/order-delete-dialog.component';
    ...
    describe( 'Order Management Delete Component', () => {
        ...
        beforeEach( async( () => {
            TestBed.configureTestingModule( {
                                                imports: [KransenzoTestModule], declarations: [OrderDeleteDialogComponent], providers: [OrderService]
                                            } )
