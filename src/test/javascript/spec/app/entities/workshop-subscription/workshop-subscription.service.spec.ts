    ...
    describe('WorkshopSubscription Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/workshop-subscriptions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a WorkshopSubscription', () => {
                service.create(new WorkshopSubscription(null)).subscribe(received => {
            ...
            it('should update a WorkshopSubscription', () => {
                service.update(new WorkshopSubscription(123)).subscribe(received => {
            ...
            it('should return a WorkshopSubscription', () => {
            ...
            it('should return a list of WorkshopSubscription', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new WorkshopSubscription(123)]);
            });
