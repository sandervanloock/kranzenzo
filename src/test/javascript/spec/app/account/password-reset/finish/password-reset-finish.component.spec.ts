    ...
    describe( 'PasswordResetFinishComponent', () => {
        ...
        beforeEach( () => {
            fixture = TestBed.configureTestingModule( {
                                                          imports: [KransenzoTestModule], declarations: [PasswordResetFinishComponent], providers: [PasswordResetFinishService, {
                    provide: ActivatedRoute, useValue: new MockActivatedRoute( {'key': 'XYZPDQ'} )
                }, {
        ...
        it( 'should update success to OK after resetting password', inject( [PasswordResetFinishService], fakeAsync( ( service: PasswordResetFinishService ) => {
            ...
            expect( service.save ).toHaveBeenCalledWith( {
                                                             key: 'XYZPDQ', newPassword: 'password'
                                                         } );
            expect( comp.success ).toEqual( 'OK' );
        } ) ) );

        it( 'should notify of generic error', inject( [PasswordResetFinishService], fakeAsync( ( service: PasswordResetFinishService ) => {
