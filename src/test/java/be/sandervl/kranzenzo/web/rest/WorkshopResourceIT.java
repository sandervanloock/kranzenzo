...
public class WorkshopResourceIT {
    ...
    public void setup() {
        ...
        final WorkshopResource workshopResource = new WorkshopResource(workshopRepository, workshopMapper);
    ...
    public void getAllWorkshops() throws Exception {
        ...
        restWorkshopMockMvc.perform(get("/api/workshops?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].neededMaterials").value(hasItem(DEFAULT_NEEDED_MATERIALS)))
            .andExpect(jsonPath("$.[*].includedInPrice").value(hasItem(DEFAULT_INCLUDED_IN_PRICE)))
            .andExpect(jsonPath("$.[*].durationInMinutes").value(hasItem(DEFAULT_DURATION_IN_MINUTES)))
            .andExpect(jsonPath("$.[*].price").value(hasItem(DEFAULT_PRICE.doubleValue())))
            .andExpect(jsonPath("$.[*].maxSubscriptions").value(hasItem(DEFAULT_MAX_SUBSCRIPTIONS)))
    ...
    public void getAllWorkshopsWithEagerRelationshipsIsEnabled() throws Exception {
        WorkshopResource workshopResource = new WorkshopResource(workshopRepositoryMock, workshopMapper);
        when(workshopRepositoryMock.findAllWithEagerRelationships(any())).thenReturn(new PageImpl(new ArrayList<>()));
    ...
    public void getWorkshop() throws Exception {
        ...
        restWorkshopMockMvc.perform(get("/api/workshops/{id}", workshop.getId()))
            ...
            .andExpect(jsonPath("$.neededMaterials").value(DEFAULT_NEEDED_MATERIALS))
            .andExpect(jsonPath("$.includedInPrice").value(DEFAULT_INCLUDED_IN_PRICE))
