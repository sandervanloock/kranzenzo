...
import be.sandervl.kranzenzo.service.dto.PasswordChangeDTO;
import be.sandervl.kranzenzo.service.dto.UserDTO;
import be.sandervl.kranzenzo.web.rest.errors.ExceptionTranslator;
import be.sandervl.kranzenzo.web.rest.vm.KeyAndPasswordVM;
import be.sandervl.kranzenzo.web.rest.vm.ManagedUserVM;
...
public class AccountResourceIntTest {
    ...
    public void testRegisterAdminIsIgnored() throws Exception {
        ...
        assertThat( userDup.get().getAuthorities() ).hasSize( 1 )
                                                    .containsExactly( authorityRepository
    ...
    public void testChangePasswordWrongExistingPassword() throws Exception {
        ...
        restMvc.perform( post( "/api/account/change-password" )
            .contentType( TestUtil.APPLICATION_JSON_UTF8 )
            .content( TestUtil
                .convertObjectToJsonBytes( new PasswordChangeDTO( "1" + currentPassword, "new password" ) ) ) )
               .andExpect( status().isBadRequest() );
