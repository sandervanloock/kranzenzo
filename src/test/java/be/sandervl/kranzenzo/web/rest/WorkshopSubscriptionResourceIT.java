...
/**
 * Integration tests for the {@link WorkshopSubscriptionResource} REST controller.
 */
@SpringBootTest(classes = KranzenzoApp.class)
public class WorkshopSubscriptionResourceIT {
    ...
    public void setup() {
        ...
        final WorkshopSubscriptionResource workshopSubscriptionResource = new WorkshopSubscriptionResource(workshopSubscriptionRepository, workshopSubscriptionMapper);
     ...
     * if they test an entity which requires the current entity.
     */
    public static WorkshopSubscription createUpdatedEntity(EntityManager em) {
        WorkshopSubscription workshopSubscription = new WorkshopSubscription()
    ...
    public void createWorkshopSubscription() throws Exception {
        ...
        WorkshopSubscription testWorkshopSubscription = workshopSubscriptionList.get(workshopSubscriptionList.size() - 1);
    ...
    public void getWorkshopSubscription() throws Exception {
        ...
        restWorkshopSubscriptionMockMvc.perform(get("/api/workshop-subscriptions/{id}", workshopSubscription.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
    ...
    public void updateWorkshopSubscription() throws Exception {
        ...
        WorkshopSubscription updatedWorkshopSubscription = workshopSubscriptionRepository.findById(workshopSubscription.getId()).get();
        ...
        updatedWorkshopSubscription
            .created(UPDATED_CREATED)
            .state(UPDATED_STATE);
        WorkshopSubscriptionDTO workshopSubscriptionDTO = workshopSubscriptionMapper.toDto(updatedWorkshopSubscription);
    ...
    public void deleteWorkshopSubscription() throws Exception {
        ...
        // Delete the workshopSubscription
        restWorkshopSubscriptionMockMvc.perform(delete("/api/workshop-subscriptions/{id}", workshopSubscription.getId())
