...
@Component( {
                selector: 'jhi-order-detail', templateUrl: './order-detail.component.html'
            } )
export class OrderDetailComponent implements OnInit, OnDestroy {
    ...
    constructor( private eventManager: JhiEventManager, private orderService: OrderService, private route: ActivatedRoute ) {
    }
