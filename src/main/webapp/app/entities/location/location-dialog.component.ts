...
export class LocationDialogComponent implements OnInit {
    ...
    constructor( public activeModal: NgbActiveModal, private locationService: LocationService, private eventManager: JhiEventManager ) {
    }
    ...
    private subscribeToSaveResponse( result: Observable<Location> ) {
        result.subscribe( ( res: Location ) => this.onSaveSuccess( res ), ( res: Response ) => this.onSaveError() );
    }
