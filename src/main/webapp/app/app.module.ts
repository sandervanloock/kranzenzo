...
@NgModule( {
               imports: [BrowserModule, KransenzoAppRoutingModule, Ng2Webstorage.forRoot( {prefix: 'jhi', separator: '-'} ), KransenzoSharedModule, KransenzoHomeModule,
                         KransenzoAdminModule, KransenzoAccountModule, KransenzoEntityModule, // jhipster-needle-angular-add-module JHipster will add new module here
               ],
