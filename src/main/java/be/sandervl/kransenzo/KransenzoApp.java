...
public class KransenzoApp {

    private static final Logger log = LoggerFactory.getLogger(KransenzoApp.class);

    private final Environment env;

    public KransenzoApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes kransenzo.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(KransenzoApp.class);
