...
public class WorkshopSubscriptionResource {
    ...
    public WorkshopSubscriptionResource( WorkshopSubscriptionRepository workshopSubscriptionRepository, WorkshopSubscriptionMapper workshopSubscriptionMapper, WorkshopSubscriptionSearchRepository workshopSubscriptionSearchRepository ) {
