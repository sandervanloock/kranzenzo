...
/**
 * REST controller for managing {@link be.sandervl.kranzenzo.domain.WorkshopDate}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class WorkshopDateResource {
    ...
    /**
     * {@code POST  /workshop-dates} : Create a new workshopDate.
     *
     * @param workshopDateDTO the workshopDateDTO to create.
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new workshopDateDTO, or with status {@code 400 (Bad Request)} if the workshopDate has already an ID.
    ...
    /**
     * {@code PUT  /workshop-dates} : Updates an existing workshopDate.
     *
     * @param workshopDateDTO the workshopDateDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated workshopDateDTO,
     * or with status {@code 400 (Bad Request)} if the workshopDateDTO is not valid,
     * or with status {@code 500 (Internal Server Error)} if the workshopDateDTO couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    public ResponseEntity<WorkshopDateDTO> updateWorkshopDate(@Valid @RequestBody WorkshopDateDTO workshopDateDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, workshopDateDTO.getId().toString()))
            .body(result);
    }

    /**
     * {@code GET  /workshop-dates} : get all the workshopDates.
     *

     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of workshopDates in body.
     */
    ...
    /**
     * {@code GET  /workshop-dates/:id} : get the "id" workshopDate.
     *
     * @param id the id of the workshopDateDTO to retrieve.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the workshopDateDTO, or with status {@code 404 (Not Found)}.
     */
    ...
    /**
     * {@code DELETE  /workshop-dates/:id} : delete the "id" workshopDate.
     *
